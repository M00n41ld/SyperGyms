...
/* harmony import */ var _vendor_tabs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_tabs__WEBPACK_IMPORTED_MODULE_2__);
// Swiper 7.4.1



var initStaffSwiper = function initStaffSwiper() {
  var staffSlider = new Swiper('.slider-container', {
    // eslint-disable-line
    loop: true,
    navigation: {
      nextEl: '.slider-next',
...
var initFeedbackSwiper = function initFeedbackSwiper() {
  var feedbackSlider = new Swiper('.swiper-reviews', {
    // eslint-disable-line
...
var tabLists = document.querySelectorAll('.membership__list');
